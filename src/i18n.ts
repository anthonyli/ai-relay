...
const translations = {
  en: {
    ...
    "import.codexAppRestart": "Restart or refresh the Codex App if the imported projects are not visible yet.",
  ...
  zh: {
    ...
    "import.codexAppRestart": "如果导入的项目还未显示，请重启或刷新 Codex App。",
